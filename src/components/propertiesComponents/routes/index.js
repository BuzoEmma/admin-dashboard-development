...
import PropertiesHousesTab from "../tabs/PropertiesHousesTab"
import PropertiesLandsTab from "../tabs/PropertiesLandsTab"


const routes = [
    // { path: '/', element: <Homepage /> },
    { path: '/houses', element: <PropertiesHousesTab /> },
    { path: '/lands', element: <PropertiesLandsTab /> },
